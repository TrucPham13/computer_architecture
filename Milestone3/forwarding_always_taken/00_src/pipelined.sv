module pipelined (
  ...
  logic                                  ex_mispred,   mem_mispred,   wb_mispred;
  ...
  logic        if_btb_hit,   id_btb_hit, ex_btb_hit;
  logic [31:0] if_br_target,             ex_br_target;
  logic [31:0] if_predicted_pc;
  logic                      id_is_jalr, ex_is_jalr;
  ...
  btb btb_inst (
    ...
    .i_ex_is_jalr  (ex_is_jalr),
    .i_ex_pc       (ex_pc),
    .i_ex_alu_data (ex_alu_data),
    .o_if_btb_hit  (if_btb_hit),
    .o_if_br_target(if_br_target)
  );
  ...
  mux2_32b predicted_pc_mux_inst (
    .i_d0 (if_pc_four),
    .i_d1 (if_br_target),
    .i_sel(if_btb_hit),
    .o_y  (if_predicted_pc)
  ...
  if_id_reg if_id_reg_inst (
    ...
    .i_if_clear  (if_flush),
    .i_if_wren   (~if_stall),
    .i_if_btb_hit(if_btb_hit),
    .i_if_pc     (if_pc),
    .i_if_pc_four(if_pc_four),
    .i_if_instr  (if_instr),
    .o_id_btb_hit(id_btb_hit),
    .o_id_pc     (id_pc),
  ...
  assign id_is_jalr  = (id_opcode == 7'h67);
  ...
  id_ex_reg id_ex_reg_inst (
    ...
    .i_id_br_op    (id_br_op),
    .i_id_btb_hit  (id_btb_hit),
    .i_id_is_jalr  (id_is_jalr),
    .i_id_pc       (id_pc),
    ...
    .o_ex_br_op    (ex_br_op),
    .o_ex_btb_hit  (ex_btb_hit),
    .o_ex_is_jalr  (ex_is_jalr),
    .o_ex_pc       (ex_pc),
  ...
  assign ex_mispred  = ex_btb_hit ^ ex_pc_sel;
